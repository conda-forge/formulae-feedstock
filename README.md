...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/formulae-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12165&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/formulae-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `formulae` can be installed with:

```
conda install formulae
```

It is possible to list all of the versions of `formulae` available on your platform with:
